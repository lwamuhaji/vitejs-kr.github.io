...
</code></pre></div><div class="tip custom-block"><p class="custom-block-title">\uCC38\uACE0</p><p><code>createServer</code>\uC640 <code>build</code>\uB294 <code>mode</code> \uC124\uC815 \uC635\uC158\uACFC <code>process.<wbr>env.</code><wbr><code>NODE_ENV</code>\uC5D0 \uC758\uC874\uD574 \uAD00\uB828 \uB3D9\uC791\uC744 \uC218\uD589\uD569\uB2C8\uB2E4. \uB530\uB77C\uC11C \uB3D9\uC77C\uD55C Node.js \uD504\uB85C\uC138\uC2A4\uC5D0\uC11C \uC774 \uB450 \uD568\uC218\uB97C \uC0AC\uC6A9\uD558\uB294 \uACBD\uC6B0 \uCDA9\uB3CC\uC774 \uBC1C\uC0DD\uB420 \uC218 \uC788\uC73C\uBA70, \uC774\uB97C \uBC29\uC9C0\uD558\uACE0\uC790 \uD55C\uB2E4\uBA74 \uB450 API\uC758 <code>process.<wbr>env.</code><wbr><code>NODE_ENV</code> \uB610\uB294 <code>mode</code> \uC124\uC815 \uC635\uC158\uC744 <code>development</code>\uB85C \uC124\uC815\uD558\uC138\uC694. \uC544\uB2C8\uBA74 \uD558\uC704 \uD504\uB85C\uC138\uC2A4\uB97C \uB9CC\uB4E4\uC5B4 API\uB97C \uAC01\uAC01 \uC2E4\uD589\uD558\uB294 \uBC29\uBC95\uB3C4 \uC788\uC2B5\uB2C8\uB2E4.</p></div><h2 id="inline-config" tabindex="-1"><code>InlineConfig</code> <a class="header-anchor" href="#inline-config" aria-hidden="true">#</a></h2><p><code>InlineConfig</code> \uC778\uD130\uD398\uC774\uC2A4\uB294 <code>UserConfig</code>\uC758 \uCD94\uAC00\uC801\uC778 \uC18D\uC131\uB4E4\uB85C \uD655\uC7A5\uB429\uB2C8\uB2E4:</p><ul><li><code>configFile</code>: \uD2B9\uC815 \uC124\uC815 \uD30C\uC77C\uC744 \uC9C0\uCE6D\uD560 \uB54C \uC0AC\uC6A9\uD569\uB2C8\uB2E4. \uB9CC\uC57D \uC124\uC815\uC774 \uB418\uC5B4\uC788\uC9C0 \uC54A\uB2E4\uBA74, Vite\uB294 \uC790\uB3D9\uC801\uC73C\uB85C \uD504\uB85C\uC81D\uD2B8 \uB8E8\uD2B8\uC5D0\uC11C \uACB0\uC815\uD569\uB2C8\uB2E4. <code>false</code>\uB85C \uC124\uC815\uD55C\uB2E4\uBA74 \uC790\uB3D9 \uC124\uC815\uC744 \uBE44\uD65C\uC131\uD654\uD569\uB2C8\uB2E4.</li><li><code>envFile</code>: <code>false</code> \uC77C \uB54C\uB294 <code>.env</code> \uD30C\uC77C\uB4E4\uC744 \uBE44\uD65C\uC131\uD654\uD569\uB2C8\uB2E4.</li></ul><h2 id="vitedevserver" tabindex="-1"><code>ViteDevServer</code> <a class="header-anchor" href="#vitedevserver" aria-hidden="true">#</a></h2><div class="language-ts"><pre><code><span class="token keyword">interface</span> <span class="token class-name">ViteDevServer</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">;</span><span class="token punctuation">(</span><span class="token keyword">async</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre></div><h2 id="preview" tabindex="-1"><code>preview</code> <a class="header-anchor" href="#preview" aria-hidden="true">#</a></h2><p><strong>\uD0C0\uC785 \uC2DC\uADF8\uB2C8\uCC98:</strong></p><div class="language-ts"><pre><code><span class="token keyword">async</span> <span class="token keyword">function</span> <span class="token function">preview</span><span class="token punctuation">(</span>inlineConfig<span class="token operator">?</span><span class="token operator">:</span> InlineConfig<span class="token punctuation">)</span><span class="token operator">:</span> <span class="token builtin">Promise</span><span class="token operator">&lt;</span>PreviewServer<span class="token operator">&gt;</span>
...
</code></pre></div>`,30),e=[o];function c(r,l,i,u,k,d){return s(),a("div",null,e)}var m=n(t,[["render",c]]);export{g as __pageData,m as default};
